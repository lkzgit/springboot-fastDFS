...
import com.demo.updown.statusCode.ResponseHelper;
import com.demo.updown.statusCode.ResponseModel;
import com.demo.updown.entity.Student1;
import com.demo.updown.entity.Student2;
...
public class ExcelController {
    ...
    public ResponseModel testObject2Excel() throws Exception{
        ...
        // 基于模板导出Excel
        FileOutputStream os = new FileOutputStream(new File("D://A.xlsx"));
    ...
    public ResponseModel testObject2BatchSheet() throws Exception{
        ...
        FileOutputStream os = new FileOutputStream(new File("D://JK.xlsx"));
        // 基于模板导出Excel
        ExcelUtils.getInstance().normalSheet2Excel(sheets, tempPath, "D://AA.xlsx");
    ...
    public ResponseModel testBatchNoTemplate2Excel() throws Exception{
        ...
        ExcelUtils.getInstance().noTemplateSheet2Excel(sheets, "D://EE.xlsx");
